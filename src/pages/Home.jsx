  ...
  return (
    <div className="home-page">
      <section className="hero">
        ...
        <p>
          We build premium, high-performance mobile and web solutions. Discover our suite of applications designed to deliver exceptional user experiences.
        </p>
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          <a href="#apps" className="btn btn-primary">
            Explore Apps <ArrowRight size={20} />
          </a>
          <a href="mailto:HazTechServices@gmail.com" className="btn btn-secondary">
            Contact Us
          </a>
        </div>
      </section>
      ...
      <section id="apps" style={{ padding: '4rem 0', textAlign: 'center' }}>
        <h2 style={{ fontSize: '2.5rem', marginBottom: '3rem' }}>Featured Products</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', textAlign: 'left' }}>
          ...
          <div className="glass" style={{ padding: '2rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <a href="https://play.google.com/store/apps/details?id=com.haztech.launcher" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary-color)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <div className="glass" style={{ padding: '2rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <a href="https://github.com/HazAnwar/markaz-app/releases/latest" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary-color)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
