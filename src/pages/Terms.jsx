    ...
    <div style={{ padding: '4rem 0' }}>
      <div className='glass' style={{ padding: '3rem', borderRadius: '1rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          ...
          <br />
          <br />
          <strong>1. Subscriptions & Purchases:</strong> Certain features may require a premium subscription or one-time purchase. All payments are securely processed through your device's respective
          app store (e.g., Google Play or Apple App Store). Subscriptions automatically renew unless canceled at least 24 hours before the end of the current period.
          <br />
          <br />
          ...
          <br />
          <br />
          If you encounter any issues or need further assistance, please reach out to our support team at{' '}
          <a href='mailto:terms@haztech.services' style={{ color: 'var(--primary-color)', textDecoration: 'underline' }}>
            terms@haztech.services
          </a>
          .
        </p>
      </div>
