  ...
  return (
    <div className='apps-page' style={{ padding: '2rem 0 4rem' }}>
      <div className='container'>
        ...
        <p style={{ textAlign: 'center', color: 'var(--text-secondary)', marginBottom: '4rem', fontSize: '1.25rem' }}>Discover our suite of premium mobile and web applications.</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '2rem', justifyContent: 'center' }}>
          <div className='glass' style={{ padding: '2.5rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)' }}>A simple, elegant, and blazing-fast launcher for your Android Mobile & TV. Available free on the Google Play Store.</p>
            </div>
          ...
          <div className='glass' style={{ padding: '2.5rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)' }}>An all-in-one beautifully designed application for Muslims - featuring accurate prayer times, qibla locator, Quran, and more.</p>
            </div>
